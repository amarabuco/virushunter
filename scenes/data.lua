...
local path = system.pathForFile( "data/score.json", system.ResourceDirectory )
...
local function onPlayBtnRelease()
	...
	composer.gotoScene( "scenes.fouls", "fade", 500 )
...
local function onPlayBtnRelease2()
	...
	-- go to level1.lua scene
	composer.gotoScene( "scenes.weapons", "fade", 500 )
...
function scene:create( event )
    ...
    local titleLogo = display.newText( "INFO", 100, 200, native.systemFont, 16, 255 )
	...
	playBtn2 = widget.newButton{
		...
		labelColor = { default={255}, over={128} },
		shape = "roundedRect",
		fillColor = { default={ 0, 0, 0, 1 }, over={ 0, 0.2, 1, 1 } },
		--default="button.png",
		--over="button-over.png",
		width=154, height=40,
